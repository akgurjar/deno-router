...
let done!: (err: Error | null, result: unknown) => void;
...
// HTTP1
{
  ...
  expectType<unknown>(router.lookup(http1Req, http1Res));
  expectType<unknown>(router.lookup(http1Req, http1Res, done));
  expectType<unknown>(router.lookup(http1Req, http1Res, ctx, done));
  expectType<Router.FindResult<Router.HTTPVersion.V1> | null>(
    router.find("GET", "/"),
  );
  expectType<Router.FindResult<Router.HTTPVersion.V1> | null>(
    router.find("GET", "/", {}),
  ...
  expectType<Router.FindRouteResult<Router.HTTPVersion.V1> | null>(
...
// HTTP2
{
  ...
  expectType<unknown>(router.lookup(http2Req, http2Res));
  expectType<unknown>(router.lookup(http2Req, http2Res, done));
  expectType<unknown>(router.lookup(http2Req, http2Res, ctx, done));
  expectType<Router.FindResult<Router.HTTPVersion.V2> | null>(
    router.find("GET", "/", {}),
  );
  expectType<Router.FindResult<Router.HTTPVersion.V2> | null>(
    router.find("GET", "/", { version: "1.0.0", host: "jsr.io" }),
  );
...
// Custom Constraint
{
  ...
  expectType<AcceptAndContentType>(
    customConstraintWithObject.deriveConstraint(http1Req, http1Res),
  );
  expectType<Router.Handler<Router.HTTPVersion.V1> | null>(
