...
Deno.test("Handler should be a function", () => {
  ...
  assertThrows(
    () => router.on("GET", "/test", 0 as unknown),
    Error,
...
Deno.test("Method already declared", async () => {
  ...
  try {
    ...
    assertEquals(
      e.message,
      "Method 'GET' already declared for route '/test' with constraints '{}'",
    );
  }
});
...
Deno.test("Method already declared nested route", async () => {
  ...
  try {
    ...
    assertEquals(
      e.message,
      "Method 'GET' already declared for route '/test/hello' with constraints '{}'",
    );
  }
});
...
Deno.test("Method already declared nested route [ignoreTrailingSlash=true]", async () => {
  ...
  Deno.test("Method already declared with constraints", async () => {
    ...
    router.on("GET", "/test", { constraints: { host: "jsr.io" } }, () => {});
    try {
      router.on("GET", "/test", { constraints: { host: "jsr.io" } }, () => {});
      fail("method already declared");
    } catch (e) {
      assertEquals(
        e.message,
        "Method 'GET' already declared for route '/test' with constraints '{\"host\":\"jsr.io\"}'",
      );
    }
  });
